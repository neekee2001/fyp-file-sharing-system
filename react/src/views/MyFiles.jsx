...
export default function MyFiles() {
    ...
    const [showUserWithAccessOpen, setShowUserWithAccessOpen] = useState(false);
    ...
    const handleShowUserWithAccessOpen = (ev, id) => {
        setSelectedFileId(id);
        setShowUserWithAccessOpen(true);
    };

    const handleShowUserWithAccessClose = () => {
        setSelectedFileId(null);
        setShowUserWithAccessOpen(false);
    };
    ...
    const handleFileDownload = () => {
        ...
        axiosClient
            .get("/file/download-myfiles/" + fileId, {
                responseType: "blob",
            })
            .then((response) => {
                handleMoreIconClose();
    ...
    return (
        <Grid>
            ...
            <FileEditDialog
                ...
                editMode="myFiles"
            />
            <ShowUserWithAccessDialog
                isOpen={showUserWithAccessOpen}
                onClose={handleShowUserWithAccessClose}
                fileId={selectedFileId}
            ></ShowUserWithAccessDialog>
        </Grid>
    );
